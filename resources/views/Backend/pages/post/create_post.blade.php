...
<form action="{{ route('post.store') }}" method="post" class="row g-3" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        ...
        <input type="text" class="form-control" name="post_title" placeholder="Enter email">
    </div>
    <div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <textarea class="tinymce-editor" name="description"></textarea><!-- End TinyMCE Editor -->
    </div>
  ...
  <h5 class="card-title"><b>SEO Tag For Google Ranking</b></h5>
    <div class="col-md-6">
        ...
        <textarea class="form-control" name="meta_title" style="height: 100px"></textarea>
    </div>
        <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" name="meta_keyword" placeholder="Enter Meta Keywords" data-role="tagsinput">
      </div>
      <div class="col-md-6">
        <label for="exampleInputEmail1">Image Alt Tag</label>
        <input type="text" class="form-control" name="alt" placeholder="Enter image Alt Tag">
      </div>
